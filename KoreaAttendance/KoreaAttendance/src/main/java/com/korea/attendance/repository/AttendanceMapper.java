...
public interface AttendanceMapper {
    ...
    @Select("""
    	    SELECT 
    	        ...
    	        s.name AS name, 
    	        s.university AS university,   -- ✅ 단과대학 추가
    	        s.department AS department,   -- ✅ 학과 추가
    	...
    	@Results(id = "AttendanceResultMap", value = {
    	    ...
    	    @Result(column = "university", property = "university"),  // ✅ 단과대학 추가
    	    @Result(column = "department", property = "department"),  // ✅ 학과 추가
